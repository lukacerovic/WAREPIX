    ...
    <div className='flex flex-col'style={{gap:'8vw', background:'linear-gradient(to bottom, black, #595858)'}}>
      ...
      <div className='flex flex-col'>
            <div className='flex sm:flex-col md:flex-col gap-10 lg:flex-row lg:gap-0 items-center' style={{paddingInline:'2vw'}}>
                <div className='text-white flex flex-col gap-10'>
                    <h1 className='sm:text-5xl md:text-6xl xl:text-7xl uppercase'>Keep Your Digital <br/>World Running Smoothly</h1>
      ...
      <div className='flex justify-between items-center text-white' style={{paddingInline:'10vw'}}>
        <div className='flex flex-col gap-10 relative' style={{ width: '55vw', borderTop:'none', borderBottom:'none', borderLeft:'none', borderRightWidth:'2px' }}>
          <div className='flex items-center justify-between pr-20'>
            <h1 className='md:text-2xl lg:text-3xl xl:text-4xl relative flex items-center gap-5 uppercase' style={{zIndex:'10'}}>
              <span style={{background:'#595858', borderRadius:'50%', borderWidth:'5px', padding:'15px', borderColor:'cyan'}}><FaBugSlash className='sm:text-4xl md:text-5xl xl:text-7xl'/></span>
                Bug Fixing
            </h1>
          ...
          <div className='flex items-center justify-between pr-20'>
            ...
            <span style={{background:'#595858', borderRadius:'50%', borderWidth:'5px', padding:'15px', borderColor:'cyan'}}><AiOutlineSafetyCertificate className='sm:text-4xl md:text-5xl xl:text-7xl'/></span>
              Security 
            </h1>
          ...
          <div className='flex items-center justify-between pr-20'>
            <h1 className='uppercase md:text-xl lg:text-3xl xl:text-4xl relative flex items-center gap-5' style={{zIndex:'10'}}>
            <span style={{background:'#595858', borderRadius:'50%', borderWidth:'5px', padding:'15px', borderColor:'cyan'}}><GrOptimize className='sm:text-4xl md:text-5xl xl:text-7xl'/></span>
              Optimization
            </h1>
          ...
          <div className='flex items-center justify-between pr-20'>
            <h1 className='md:text-xl lg:text-3xl xl:text-4xl relative flex items-center gap-5' style={{zIndex:'10'}}>
            <span style={{background:'#595858', borderRadius:'50%', borderWidth:'5px', padding:'15px', borderColor:'cyan'}}><FaTeamspeak className='sm:text-4xl md:text-5xl xl:text-7xl'/></span>
        ...
        <div style={{ width: '35vw', paddingLeft:'3vw' }}>
          {activeSection === 'bug' && (
            <p className=' md:text-sm lg:text-md xl:text-xl'>
      ...
      <div className='text-white flex flex-col mt-10' style={{background: 'transparent', paddingInline:'3vw'}}>
        <h1 className='text-3xl md:text-4xl xl:text-5xl pb-10 text-pink-500 uppercase self-center'>Smooth And Safe</h1>
        <p className='text-md lg:text-md xl:text-xl self-center text-center' style={{width:'80vw'}}>
