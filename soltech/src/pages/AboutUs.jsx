...
export default function AboutUs() {
  ...
  return (
    <div className='flex flex-col' style={{background:'#181818'}}>
        ...
        <div style={{background:'linear-gradient(#0B042E, #a9a9a9)', paddingInline:'2vw'}} className='flex py-3 md:py-4 lg:py-6 xl:py-8 mb-20 justify-between'>
        ...
        <div className='w-[80%] self-center text-white mb-[3vw]'>
            <p style={{fontSize:'2vw'}} className='text-center'>
        ...
        <div className='flex pt-10 px-10 self-center items-center gap-10 mb-20'>
            ...
            <div className='text-white' style={{width:'50vw', borderLeftWidth:'1px', paddingInline:'2vw'}}>
                <h1 style={{fontSize:'4vw'}}>ABOUT US</h1>
...
Experience the WAREPIX difference today, and unlock the full potential of your digital future.
        ...
        <div className='flex items-center justify-center self-center' style={{marginTop:'7vw', marginBottom:'3vw'}}>
            <img src='images/1.png' style={{width:'30vw'}}/>
            <img src='images/3.png'style={{width:'30vw'}}/>
            <img src='images/2.png'style={{width:'30vw'}}/>
        </div>
    
        <button className='self-center text-white rounded-lg' type='button' onClick={() => setReviewsVisible(true)} style={{width:'15vw', background:'#3B3A3A', padding:'0.8vw', fontSize:'1.3vw', marginBottom:'5vw'}}>
            See All Reviews
        </button>
        {reviews && (
            <div className='flex flex-col self-center items-center, justify-center rounded-lg' style={{background:'#3B3A3A', padding:'1vw', width:'80vw', gap:'3vw'}}>
                <div className='flex flex-col items-center overflow-y-auto max-h-[35vw]' style={{gap:'2vw', padding:'1vw'}}>
                    <div className='flex bg-slate-400 shadow-2xl rounded-lg items-center justify-between' style={{width:'85%',padding:'1vw',color:'black', gap:'2vw'}}>
                        <span style={{borderRadius:'50%', width:'3vw', height:'3vw', fontSize:'1.5vw',color:'black', background:'#7ED957'}} className='flex items-center justify-center'>R</span>
                        <p style={{width:'70%', fontSize:'1vw'}}>I am absolutely blown away by the mobile development service! They transformed my vision into a stunning mobile app with precision and finesse. From user experience to functionality, they nailed every aspect. I couldn't be happier with the result! Highly recommend their exceptional mobile development service!</p>
                        <div className='flex items-center'>
                            <p style={{fontSize:'2vw'}}>5 /</p>
                            <IoMdStar color='#FFDE59' size={'3vw'}/>
                        </div>
                    </div>
                    <div className='flex bg-slate-400 shadow-2xl rounded-lg items-center justify-between' style={{width:'85%',padding:'1vw',color:'black', gap:'2vw'}}>
                        <span style={{borderRadius:'50%', width:'3vw', height:'3vw', fontSize:'1.5vw',color:'black', background:'#62CBFF'}} className='flex items-center justify-center'>M</span>
                        <p style={{width:'70%', fontSize:'1vw'}}>Our collaboration with WAREPIX on web app development was nothing short of exceptional. From the outset, their team displayed a deep understanding of our project requirements and user needs. They guided us through every step of the development process, offering valuable insights and suggestions along the way. The result? A beautifully designed, feature-rich app that has received rave reviews from our users. WAREPIX's professionalism, attention to detail, and commitment to client satisfaction make them a trusted partner for all our future projects.</p>
                        <div className='flex items-center'>
                            <p style={{fontSize:'2vw'}}>5 /</p>
                            <IoMdStar color='#FFDE59' size={'3vw'}/>
                        </div>
                    ...
                    <div className='flex bg-slate-400 shadow-2xl rounded-lg items-center justify-between' style={{width:'85%',padding:'1vw',color:'black', gap:'2vw'}}>
                        <span style={{borderRadius:'50%', width:'3vw', height:'3vw', fontSize:'1.5vw',color:'black', background:'#EF962D'}} className='flex items-center justify-center'>O</span>
                        <p style={{width:'70%', fontSize:'1vw'}}>The logo WAREPIX created for us is simply perfect. It captures the essence of our brand beautifully. The team understood our vision and translated it into a memorable logo that sets us apart. It's clean, elegant, and timeless. Couldn't be happier with the result</p>
                        <div className='flex items-center'>
                            <p style={{fontSize:'2vw'}}>4 /</p>
                            <IoMdStar color='#FFDE59' size={'3vw'}/>
                        </div>
                    </div>
                    <div className='flex bg-slate-400 shadow-2xl rounded-lg items-center justify-between' style={{width:'85%',padding:'1vw',color:'black', gap:'2vw'}}>
                        <span style={{borderRadius:'50%', width:'3vw', height:'3vw', fontSize:'1.5vw',color:'black', background:'#B20050'}} className='flex items-center justify-center'>D</span>
                        <p style={{width:'70%', fontSize:'1vw'}}>Great experience working with WAREPIX on our website. They were responsive and professional throughout the process.</p>
                        <div className='flex items-center'>
                            <p style={{fontSize:'2vw'}}>4 /</p>
                            <IoMdStar color='#FFDE59' size={'3vw'}/>
                        </div>
                    ...
                    <div className='flex bg-slate-400 shadow-2xl rounded-lg items-center justify-between' style={{width:'85%',padding:'1vw',color:'black', gap:'2vw'}}>
                        <span style={{borderRadius:'50%', width:'3vw', height:'3vw', fontSize:'1.5vw',color:'black', background:'#FF5757'}} className='flex items-center justify-center'>K</span>
                        <p style={{width:'70%', fontSize:'1vw'}}>Working with WAREPIX for our logo and animations was a breeze. Their professionalism and expertise made the entire process seamless. The end result was beyond what we envisioned. I wouldn't hesitate to recommend WAREPIX to anyone looking for top-notch design services.</p>
                        <div className='flex items-center'>
                            <p style={{fontSize:'2vw'}}>5 /</p>
                            <IoMdStar color='#FFDE59' size={'3vw'}/>
                        </div>
                    ...
                    <div className='flex bg-slate-400 shadow-2xl rounded-lg items-center justify-between' style={{width:'85%',padding:'1vw',color:'black', gap:'2vw'}}>
                        <span style={{borderRadius:'50%', width:'3vw', height:'3vw', fontSize:'1.5vw',color:'black', background:'blue'}} className='flex items-center justify-center'>J</span>
                        <p style={{width:'70%', fontSize:'1vw'}}>WAREPIX truly understands the importance of branding and user experience. Their WEB Mobile Logo and Animation Build service transformed our product into a visually stunning platform. Their team's dedication to quality and innovation is commendable. We're thrilled with the results!</p>
                        <div className='flex items-center'>
                            <p style={{fontSize:'2vw'}}>5 /</p>
                            <IoMdStar color='#FFDE59' size={'3vw'}/>
                        </div>
                    ...
                    <div className='flex bg-slate-400 shadow-2xl rounded-lg items-center justify-between' style={{width:'85%',padding:'1vw',color:'black', gap:'2vw'}}>
                        <span style={{borderRadius:'50%', width:'3vw', height:'3vw', fontSize:'1.5vw',color:'black', background:'#7ED957'}} className='flex items-center justify-center'>V</span>
                        <p style={{width:'70%', fontSize:'1vw'}}>Animation service is top-notch. They brought our brand to life with captivating animations that add a dynamic element to our marketing campaigns. From concept to execution, the process was smooth and the results exceeded our expectations. The animations truly elevate our brand presence.</p>
                        <div className='flex items-center'>
                            <p style={{fontSize:'2vw'}}>4 /</p>
                            <IoMdStar color='#FFDE59' size={'3vw'}/>
                        </div>
                    ...
                    <div className='flex bg-slate-400 shadow-2xl rounded-lg items-center justify-between' style={{width:'85%',padding:'1vw',color:'black', gap:'2vw'}}>
                        <span style={{borderRadius:'50%', width:'3vw', height:'3vw', fontSize:'1.5vw',color:'black', background:'#FD2AAF'}} className='flex items-center justify-center'>W</span>
                        <p style={{width:'70%', fontSize:'1vw'}}>The animation services provided by WAREPIX added a whole new level of engagement to our website. Love the creativity!</p>
                        <div className='flex items-center'>
                            <p style={{fontSize:'2vw'}}>5 /</p>
                            <IoMdStar color='#FFDE59' size={'3vw'}/>
                        </div>
                    ...
                    <div className='flex bg-slate-400 shadow-2xl rounded-lg items-center justify-between' style={{width:'85%',padding:'1vw',color:'black', gap:'2vw'}}>
                        <span style={{borderRadius:'50%', width:'3vw', height:'3vw', fontSize:'1.5vw',color:'black', background:'#0097B2'}} className='flex items-center justify-center'>Z</span>
                        <p style={{width:'70%', fontSize:'1vw'}}>Overall, I'm quite satisfied with the web development service provided by WAREPIX. The website looks great and functions well. However, there were a few delays in the delivery process which affected our launch timeline. Nonetheless, the team was responsive to our concerns and addressed them promptly.</p>
                        <div className='flex items-center'>
                            <p style={{fontSize:'2vw'}}>3 /</p>
                            <IoMdStar color='#FFDE59' size={'3vw'}/>
                        </div>
                    </div>
                    <div className='flex bg-slate-400 shadow-2xl rounded-lg items-center justify-between' style={{width:'85%',padding:'1vw',color:'black', gap:'2vw'}}>
                        <span style={{borderRadius:'50%', width:'3vw', height:'3vw', fontSize:'1.5vw',color:'black', background:'#8E00B2'}} className='flex items-center justify-center'>T</span>
                        <p style={{width:'70%', fontSize:'1vw'}}>The web service was exceptional. They created a user-friendly and visually appealing website that perfectly represents our brand. Their attention to detail and prompt communication made the entire process smooth and enjoyable. Highly recommend!</p>
                        <div className='flex items-center'>
                            <p style={{fontSize:'2vw'}}>5 /</p>
                            <IoMdStar color='#FFDE59' size={'3vw'}/>
                        </div>
                    ...
                    <div className='flex bg-slate-400 shadow-2xl rounded-lg items-center justify-between' style={{width:'85%',padding:'1vw',color:'black', gap:'2vw'}}>
                        <span style={{borderRadius:'50%', width:'3vw', height:'3vw', fontSize:'1.5vw',color:'black', background:'#AEB200'}} className='flex items-center justify-center'>R</span>
                        <p style={{width:'70%', fontSize:'1vw'}}>We engaged WAREPIX for logo design services and were generally pleased with the results. The initial concepts presented were creative and captured our brand essence well. However, we felt that the revision process could have been more collaborative, and the final files were delivered later than expected. Nonetheless, the final logo met our expectations and it's fantastic!</p>
                        <div className='flex items-center'>
                            <p style={{fontSize:'2vw'}}>4 /</p>
                            <IoMdStar color='#FFDE59' size={'3vw'}/>
                        </div>
                    ...
                    <div className='flex bg-slate-400 shadow-2xl rounded-lg items-center justify-between' style={{width:'85%',padding:'1vw',color:'black', gap:'2vw'}}>
                        <span style={{borderRadius:'50%', width:'3vw', height:'3vw', fontSize:'1.5vw',color:'black', background:'#2AF6FD'}} className='flex items-center justify-center'>P</span>
                        <p style={{width:'70%', fontSize:'1vw'}}>Absolutely thrilled with the logo design service from WAREPIX! They nailed it! From concept to execution, they blew me away with their creativity and attention to detail. Highly recommend their outstanding logo design service!</p>
                        <div className='flex items-center'>
                            <p style={{fontSize:'2vw'}}>5 /</p>
                            <IoMdStar color='#FFDE59' size={'3vw'}/>
                        </div>
                    ...
                    <div className='flex bg-slate-400 shadow-2xl rounded-lg items-center justify-between' style={{width:'85%',padding:'1vw',color:'black', gap:'2vw'}}>
                        <span style={{borderRadius:'50%', width:'3vw', height:'3vw', fontSize:'1.5vw',color:'black', background:'#B20050'}} className='flex items-center justify-center'>F</span>
                        <p style={{width:'70%', fontSize:'1vw'}}>Wow! WAREPIX totally nailed it with our new logo design. Their creativity knows no bounds. Highly recommend!</p>
                        <div className='flex items-center'>
                            <p style={{fontSize:'2vw'}}>5 /</p>
                            <IoMdStar color='#FFDE59' size={'3vw'}/>
                        </div>
                    ...
                    <div className='flex bg-slate-400 shadow-2xl rounded-lg items-center justify-between' style={{width:'85%',padding:'1vw',color:'black', gap:'2vw'}}>
                        <span style={{borderRadius:'50%', width:'3vw', height:'3vw', fontSize:'1.5vw',color:'black', background:'#42FF77'}} className='flex items-center justify-center'>V</span>
                        <p style={{width:'70%', fontSize:'1vw'}}>WAREPIX is my go-to for web development. They've consistently delivered exceptional results. Kudos to the team!</p>
                        <div className='flex items-center'>
                            <p style={{fontSize:'2vw'}}>5 /</p>
                            <IoMdStar color='#FFDE59' size={'3vw'}/>
                        </div>
                    ...
                    <div className='flex bg-slate-400 shadow-2xl rounded-lg items-center justify-between' style={{width:'85%',padding:'1vw',color:'black', gap:'2vw'}}>
                        <span style={{borderRadius:'50%', width:'3vw', height:'3vw', fontSize:'1.5vw',color:'black', background:'#EF962D'}} className='flex items-center justify-center'>J</span>
                        <p style={{width:'70%', fontSize:'1vw'}}>Although the process of mobile app dev took longer than expected due to initial uncertainties about our requirements, WAREPIX remained dedicated to finding the right solution. The final outcome met our expectations, but the extended timeline was challenging.</p>
                        <div className='flex items-center'>
                            <p style={{fontSize:'2vw'}}>3 /</p>
                            <IoMdStar color='#FFDE59' size={'3vw'}/>
                        </div>
                    ...
                    <div className='flex bg-slate-400 shadow-2xl rounded-lg items-center justify-between' style={{width:'85%',padding:'1vw',color:'black', gap:'2vw'}}>
                        <span style={{borderRadius:'50%', width:'3vw', height:'3vw', fontSize:'1.5vw',color:'black', background:'#FF5757'}} className='flex items-center justify-center'>K</span>
                        <p style={{width:'70%', fontSize:'1vw'}}>WAREPIX handled our web, mobile, and logo design projects with utmost professionalism. They brought our vision to life and provided excellent support throughout. Highly recommend their comprehensive services.</p>
                        <div className='flex items-center'>
                            <p style={{fontSize:'2vw'}}>5 /</p>
                            <IoMdStar color='#FFDE59' size={'3vw'}/>
                        </div>
                    ...
                    <div className='flex bg-slate-400 shadow-2xl rounded-lg items-center justify-between' style={{width:'85%',padding:'1vw',color:'black', gap:'2vw'}}>
                        <span style={{borderRadius:'50%', width:'3vw', height:'3vw', fontSize:'1.5vw',color:'black', background:'#FD8F2A'}} className='flex items-center justify-center'>S</span>
                        <p style={{width:'70%', fontSize:'1vw'}}>I am thoroughly impressed with the overall experience provided by WAREPIX. Their commitment to quality and customer satisfaction is evident in every aspect of their service. Thank you for exceeding my expectations!</p>
                        <div className='flex items-center'>
                            <p style={{fontSize:'2vw'}}>5 /</p>
                            <IoMdStar color='#FFDE59' size={'3vw'}/>
                        </div>
                    ...
                    <div className='flex bg-slate-400 shadow-2xl rounded-lg items-center justify-between' style={{width:'85%',padding:'1vw',color:'black', gap:'2vw'}}>
                        <span style={{borderRadius:'50%', width:'3vw', height:'3vw', fontSize:'1.5vw',color:'black', background:'#FD2A2A'}} className='flex items-center justify-center'>J</span>
                        <p style={{width:'70%', fontSize:'1vw'}}>There were a few bumps along the way during our animation project, but WAREPIX handled them professionally. The final outcome was satisfactory.</p>
                        <div className='flex items-center'>
                            <p style={{fontSize:'2vw'}}>4 /</p>
                            <IoMdStar color='#FFDE59' size={'3vw'}/>
                        </div>
                    ...
                    <div className='flex bg-slate-400 shadow-2xl rounded-lg items-center justify-between' style={{width:'85%',padding:'1vw',color:'black', gap:'2vw'}}>
                        <span style={{borderRadius:'50%', width:'3vw', height:'3vw', fontSize:'1.5vw',color:'black', background:'#2AF6FD'}} className='flex items-center justify-center'>L</span>
                        <p style={{width:'70%', fontSize:'1vw'}}>Our mobile app developed by WAREPIX is sleek and intuitive. They understood our vision perfectly</p>
                        <div className='flex items-center'>
                            <p style={{fontSize:'2vw'}}>5 /</p>
                            <IoMdStar color='#FFDE59' size={'3vw'}/>
                        </div>
                    ...
                    <div className='flex bg-slate-400 shadow-2xl rounded-lg items-center justify-between' style={{width:'85%',padding:'1vw',color:'black', gap:'2vw'}}>
                        <span style={{borderRadius:'50%', width:'3vw', height:'3vw', fontSize:'1.5vw',color:'black', background:'#F9FD2A'}} className='flex items-center justify-center'>Y</span>
                        <p style={{width:'70%', fontSize:'1vw'}}>team did an excellent job revamping our website. They were responsive to our needs and delivered on time. Impressed!</p>
                        <div className='flex items-center'>
                            <p style={{fontSize:'2vw'}}>5 /</p>
                            <IoMdStar color='#FFDE59' size={'3vw'}/>
                        </div>
                    ...
                    <div className='flex bg-slate-400 shadow-2xl rounded-lg items-center justify-between' style={{width:'85%',padding:'1vw',color:'black', gap:'2vw'}}>
                        <span style={{borderRadius:'50%', width:'3vw', height:'3vw', fontSize:'1.5vw',color:'black', background:'#2AFD45'}} className='flex items-center justify-center'>U</span>
                        <p style={{width:'70%', fontSize:'1vw'}}>Experience with WAREPIX for logo design was fantastic! They captured our brand identity perfectly. Can't thank them enough for their creativity!</p>
                        <div className='flex items-center'>
                            <p style={{fontSize:'2vw'}}>5 /</p>
                            <IoMdStar color='#FFDE59' size={'3vw'}/>
                        </div>
                    ...
                    <div className='flex bg-slate-400 shadow-2xl rounded-lg items-center justify-between' style={{width:'85%',padding:'1vw',color:'black', gap:'2vw'}}>
                        <span style={{borderRadius:'50%', width:'3vw', height:'3vw', fontSize:'1.5vw',color:'black', background:'#A02AFD'}} className='flex items-center justify-center'>A</span>
                        <p style={{width:'70%', fontSize:'1vw'}}>WAREPIX went above and beyond with our web development project! Their attention to detail and dedication to our vision were unmatched. Highly recommended.</p>
                        <div className='flex items-center'>
                            <p style={{fontSize:'2vw'}}>5 /</p>
                            <IoMdStar color='#FFDE59' size={'3vw'}/>
                        </div>
                    ...
                    <div className='flex bg-slate-400 shadow-2xl rounded-lg items-center justify-between' style={{width:'85%',padding:'1vw',color:'black', gap:'2vw'}}>
                        <span style={{borderRadius:'50%', width:'3vw', height:'3vw', fontSize:'1.5vw',color:'black', background:'#CB8120'}} className='flex items-center justify-center'>C</span>
                        <p style={{width:'70%', fontSize:'1vw'}}>The animation created by WAREPIX was visually stunning! Minor delays in delivery, but the quality of work compensated for it. Would recommend.</p>
                        <div className='flex items-center'>
                            <p style={{fontSize:'2vw'}}>4 /</p>
                            <IoMdStar color='#FFDE59' size={'3vw'}/>
                        </div>
                    ...
                    <div className='flex bg-slate-400 shadow-2xl rounded-lg items-center justify-between' style={{width:'85%',padding:'1vw',color:'black', gap:'2vw'}}>
                        <span style={{borderRadius:'50%', width:'3vw', height:'3vw', fontSize:'1.5vw',color:'black', background:'#4720CB'}} className='flex items-center justify-center'>Z</span>
                        <p style={{width:'70%', fontSize:'1vw'}}>User-friendly website that perfectly represents our brand!!
                ...
                <p className='text-center text-white' style={{fontSize:'1.3vw'}}>Leave Review</p>
                <form
                    onSubmit={handleSendReview}
                >
                    <div className='flex items-center' style={{gap:'1.5vw', fontSize:'1.3vw'}}>
        ...
        <div className='flex flex-col text-white mt-[10vw] mb-[10vw]' style={{paddingInline:'1vw'}}>
            <p style={{fontSize:'1.3vw', width:'85%'}} className='text-center self-center'>
...
What sets us apart is our holistic approach to digital solutions. We don't just create websites or apps – we craft immersive experiences that resonate with your audience and drive meaningful engagement. From concept to execution, we work closely with our clients to ensure every aspect of their digital strategy aligns with their goals and objectives.
            ...
            <img src='images/wearpixBig.png' className='self-center'/>
            <p style={{fontSize:'1.3vw', width:'85%'}} className='text-center self-center'>
...
Experience the difference with WAREPIX. Let us be your trusted partner in the digital world.
        ...
        <Link className='self-center pt-20 pb-10' to='http://localhost:5173/#contact'>
          <button className='bg-cyan-500 rounded-lg' style={{fontSize:'1.5vw', paddingInline:'1.5vw', paddingTop:'1vw', paddingBottom:'1vw'}}>Contact Us</button>
        </Link>
        <Footer/>
    </div>
  )
