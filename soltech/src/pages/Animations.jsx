  ...
  return (
    ...
    <div className='flex flex-col'style={{gap:'8vw', background:'linear-gradient(to bottom, black, #595858)'}}>
      ...
      <div className='flex flex-col'>
            <div className='flex sm:flex-col md:flex-col lg:flex-col xl:flex-row gap-10 lg:gap-0 items-center' style={{paddingInline:'2vw'}}>
                <div className='text-white flex flex-col gap-10' style={{width:'60vw'}}>
                    <h1 className='uppercase' style={{fontSize:'4vw'}}>Animate Your <br/>Imagination</h1>
        ...
        <div className='flex flex-col gap-10 relative' style={{ width: '55vw', borderTop:'none', borderBottom:'none', borderLeft:'none', borderRightWidth:'2px' }}>
          <div className='flex items-center justify-between pr-20'>
            <h1 className='md:text-2xl lg:text-3xl xl:text-4xl relative flex items-center gap-5 uppercase' style={{zIndex:'10'}}>
              <span style={{background:'#595858', borderRadius:'50%', borderWidth:'5px', padding:'15px', borderColor:'cyan'}}><TfiThought className='sm:text-4xl md:text-5xl xl:text-7xl'/></span>
              Storyboarding
            </h1>
          ...
          <div className='flex items-center justify-between pr-20'>
            ...
            <span style={{background:'#595858', borderRadius:'50%', borderWidth:'5px', padding:'15px', borderColor:'cyan'}}><FaOptinMonster className='sm:text-4xl md:text-5xl xl:text-7xl'/></span>
              Character Design
            </h1>
          ...
          <div className='flex items-center justify-between pr-20'>
            <h1 className='uppercase md:text-xl lg:text-3xl xl:text-4xl relative flex items-center gap-5' style={{zIndex:'10'}}>
            <span style={{background:'#595858', borderRadius:'50%', borderWidth:'5px', padding:'15px', borderColor:'cyan'}}><MdDraw className='sm:text-4xl md:text-5xl xl:text-7xl'/></span>
          ...
          <div className='flex items-center justify-between pr-20'>
            ...
            <span style={{background:'#595858', borderRadius:'50%', borderWidth:'5px', padding:'15px', borderColor:'cyan',}}><VscGitPullRequestCreate className='sm:text-4xl md:text-5xl xl:text-7xl'/></span>
          ...
          <div className='flex items-center justify-between pr-20'>
            <h1 className='md:text-xl lg:text-3xl xl:text-4xl relative flex items-center gap-5' style={{zIndex:'10'}}>
            <span style={{background:'#595858', borderRadius:'50%', borderWidth:'5px', padding:'15px', borderColor:'cyan'}}><MdOutlineFormatShapes className='sm:text-4xl md:text-5xl xl:text-7xl'/></span>
              Multiple Formats
            </h1>
