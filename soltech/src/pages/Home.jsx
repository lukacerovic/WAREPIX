...
export default function Home() {
  ...
  return (
    <div className="flex flex-col">
      <div style={{ background: "linear-gradient(to bottom, black, #595858)" }}>
        <NavBar />
          ...
          <div className="flex gap-10 px-[5vw] flex-1 flex-wrap self-center justify-center">
            ...
            >
              ...
              <p style={{padding:'0.5vw'}} className='text-xs  md:text-sm lg:text-md xl:text-lg 2xl:text-2xl'>
                ...
                approach to MVP project development, ensuring a streamlined and
                successful launch.
              </p>
            ...
            >
              ...
              <p style={{padding:'0.5vw'}} className='text-xs  md:text-sm lg:text-md xl:text-lg 2xl:text-2xl'>
                ...
                offer a holistic approach to logo creation, ensuring a
