    ...
    <div className='flex flex-col'style={{gap:'8vw', background:'linear-gradient(to bottom, black, #595858)'}}>
      ...
      <div className='flex flex-col'>
            <div className='flex sm:flex-col md:flex-col gap-10 lg:flex-row lg:gap-0 items-center' style={{paddingInline:'2vw'}}>
                <div className='text-white flex flex-col gap-10' style={{width:'60vw'}}>
                    <h1 className='uppercase' style={{fontSize:'4vw'}}>Mobile<br/> Excellence</h1>
      ...
      <div className='flex justify-between items-center text-white' style={{paddingInline:'10vw'}}>
        <div className='flex flex-col gap-10 relative' style={{ width: '55vw', borderTop:'none', borderBottom:'none', borderLeft:'none', borderRightWidth:'2px' }}>
          ...
          <div className='flex items-center justify-between pr-20'>
            <h1 className='md:text-xl lg:text-3xl xl:text-4xl relative flex items-center gap-5' style={{zIndex:'10'}}>
            <span style={{background:'#595858', borderRadius:'50%', borderWidth:'5px', padding:'15px', borderColor:'cyan',}}><DiAndroid className='sm:text-4xl md:text-5xl xl:text-7xl'/></span>
              ANDROID
            </h1>
          ...
          <div className='flex items-center justify-between pr-20'>
            <h1 className='md:text-xl lg:text-3xl xl:text-4xl relative flex items-center gap-5' style={{zIndex:'10'}}>
            <span style={{background:'#595858', borderRadius:'50%', borderWidth:'5px', padding:'15px', borderColor:'cyan'}}><DiApple className='sm:text-4xl md:text-5xl xl:text-7xl'/></span>
              IOS
            </h1>
      ...
      <div className='flex flex-col items-center justify-center text-white py-10 mb-10' style={{background: 'transparent', paddingInline:'1vw'}}>
        <h1 className='text-5xl md:text-7xl lg:text-8xl xl:text-8xl' style={{marginBottom:'6vw'}}>Samples Of Design</h1>
